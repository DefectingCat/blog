...
![主进程与子进程间的通信](/images/built-simply-faas/主进程与子进程间的通信.svg)
...
![主进程与子进程间的通信](/images/built-simply-faas/通过子进程动态运行函数代码片段.svg)
...
![在隔离的沙箱中执行函数](/images/built-simply-faas/在隔离的沙箱中执行函数.svg)
...
![用户通过HTTP触发函数的流程](/images/built-simply-faas/用户通过HTTP触发函数的流程.svg)
...
![通过进程池管理子进程](/images/built-simply-faas/通过进程池管理子进程.svg)
...
{{ image(path="/images/built-simply-faas/book.jpg", alt="book") }}
