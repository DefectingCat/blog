...
{{ image(path="/images/generic-component-encapsulate-reusable-component/Untitled.png", alt="无法获取其状态") }}
...
{{ image(path="/images/generic-component-encapsulate-reusable-component/Untitled-1.png", alt="未约束的泛型") }}
...
{{ image(path="/images/generic-component-encapsulate-reusable-component/Untitled-2.png", alt="传递数字给泛型") }}

{{ image(path="/images/generic-component-encapsulate-reusable-component/Untitled-3.png", alt="传递字符串给泛型") }}
...
{{ image(path="/images/generic-component-encapsulate-reusable-component/Untitled-4.png", alt="类型推断") }}
...
{{ image(path="/images/generic-component-encapsulate-reusable-component/Untitled-5.png", alt="类型推断") }}
