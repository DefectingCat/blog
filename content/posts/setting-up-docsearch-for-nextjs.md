...
{{ image(path="/images/setting-up-docsearch-for-nextjs/cannot-login-to-algolia-crawler.png", alt="Can't login to Algolia Crawler") }}
...
{{ image(path="/images/setting-up-docsearch-for-nextjs/index-format.png", alt="Index format") }}
